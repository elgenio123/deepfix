...
description: "Use DeepFix to diagnose image classification datasets end-to-end."
---
...
- DeepFix installed and configured (see [Installation Guide](/getting-started/installation))
...
3. **Overlap Detection**: Check for train/test overlap (handled automatically with `train_test_validation=True`).
...
- [Tabular Data Guide](/guides/tabular-data) – Work with structured data
