...
description: "Use DeepFix to diagnose tabular (structured) datasets backed by pandas or CSV/Parquet files."
---
...
deepchecks_result = result.agent_results.get("DeepchecksArtifactsAnalyzer")
if deepchecks_result is not None:
    print("Deepchecks Findings:", deepchecks_result.findings)
...
- [NLP Datasets Guide](/guides/nlp-datasets) – Analyze text datasets
