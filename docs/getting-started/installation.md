...
See the [Docker Deployment Guide](../deployment/docker.md) for detailed instructions and configuration options.
...
2. **Configure MLflow** (optional):
   ...
   - See [MLflow Integration Guide](../guides/mlflow-integration.md)

3. **Verify Setup**:
   - Start the server: `uv run deepfix-server launch`
   - Test client connection
   - See [Quickstart Guide](quickstart.md) for examples
...
See the [Configuration Guide](configuration.md) and [Deployment Guide](../deployment/docker.md) for more troubleshooting tips.
