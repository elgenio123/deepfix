        ...
        self.register(
            ...
            optional_params={
                "train": {
                    "default": True,
                    "type": bool,
                    "description": "Load training or test set",
                },
                "batch_size": {
                    "default": 8,
                    "type": int,
                    "description": "Batch size for data loader",
                },
                "shuffle": {
                    "default": False,
                    "type": bool,
                ...
                "pin_memory": {
                    "default": True,
                    "type": bool,
                    "description": "Pin memory for CUDA",
                },
                "object_type": {
                    "default": "VisionData",
                    "type": str,
                    "description": "Return type (VisionData or DataLoader)",
                },
            },
        )
        ...
        self.register(
            ...
            optional_params={
                "train": {
                    "default": True,
                    "type": bool,
                    "description": "Load training or validation set",
                },
                "batch_size": {
                    "default": 8,
                    "type": int,
        ...
        self.register(
            ...
            optional_params={
                ...
                "day_index": {
                    "default": 0,
                    "type": int,
                    "description": "Day index (0=training, 1-59=production days)",
                },
            },
        )
        ...
        self.register(
            ...
            optional_params={
                "dataset_name": {
                    "default": "coco",
                    "type": str,
                    "description": "Segmentation dataset name",
                },
                "train": {
                    "default": True,
                    "type": bool,
