    ...
    def __init__(self, dataset_name: str, 
        ...
        if isinstance(dataset, pd.DataFrame):
            ...
            if len(cat_features) == 0:
                logger.warning("No categorical features provided, will automatically detect them. (Not Recommended)")
            self.dataset = DeepchecksTabularDataset(dataset, label=label, cat_features=cat_features)
